...
const img=Urlimage.url;
  ...
  const totalPages = Math.ceil(itemPromotion.length / limit);
  const paginatedItems = itemPromotion.slice((currentPage - 1) * limit, currentPage * limit);
      ...
      <div id="promotions" class="section-container bg-component  pt-20px" >
        <div class="container">
          <ul className="breadcrumb fs-16px">
            ...
            <li className="breadcrumb-item active">ລາຍການໂປຣໂມຊັ່ນ</li>
          </ul>
                  ...
                  <div key={index} class="col-lg-3 col-md-4 col-sm-6 mb-2">
                    <div class="item item-thumbnail">
                      ...
                      <div class="item-info text-start">
                        ...
                        <p class="item-desc">{val.promotion_detail}</p>
                      </div>
                    </div>
                  </div>
                )}
